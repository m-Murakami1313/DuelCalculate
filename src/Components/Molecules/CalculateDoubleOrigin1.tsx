...
import { DisplayDouble1 } from "../Atom/DisplayDouble1";
import { useNumberButtonDouble } from "../../hooks/useNumberButtonDouble";

export const CalculateDoubleOrigin1: VFC = memo(() => {
  const {
    display,
    calculate,
    click0,
  ...
  const onClickReturn = () => history.push("/page1");
  ...
  return (
    <>
      <Box
        ...
        mr={5}
      >
        <DisplayDouble1 value={display} />
        <DisplayDouble1 value={calculate} />
        <Box>
          ...
          <Stack direction="row" m={2}>
            ...
            <CalButton number={"R"} onClick={onClickReturn} />
          </Stack>
        </Box>
      </Box>
    </>
